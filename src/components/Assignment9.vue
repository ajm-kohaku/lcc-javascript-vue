...
<script>
import Accordion from './Assignment9Accordion.vue'
export default {
  name: 'Assignment9',
  components: {
    Accordion,
      ...
      accordionData: [
        {
          ...
          message:
            'This page represents an example of accordion design. It is very simple and can help save screen real estate.',
          comp: '',
        },
        {
          id: 2,
